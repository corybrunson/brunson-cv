...
\item
``The Hispanic Paradox in Lung Transplant Outcomes: Disentangling the Roles of Primary Diagnosis, Monitoring Period, Age, and Era'', ATS 2024 International Conference, San Diego CA, 2024~May~17--22 (accepted)
\item
...
\item
``Machine Learning with Multi-Site Cytokines Predicts Post--Lung Transplant Primary Graft Dysfunction'', Annual Meeting \& Scientific Sessions of the ISHLT, Prague, Czech Republic, 2024~Apr~10--13 (accepted)
%\item
%``Machine learning and integer programming yield simple risk scores that can increase detection of severe alpha-1 antitrypsin deficiency'', College of Medicine Celebration of Research, Gainesville FL, 2024~Feb~12
%\item
%``Computational models of chronic lung allograft dysfunction following lung transplantation: A scoping review'', Department of Medicine Celebration of Research, Gainesville FL, 2023~Oct~26
%\item
%``Efficient Modeling of Individualized COVID-19 Mortality Risk'', UF CTSI Learning Health System Research Day, Gainesville FL, 2023~Apr~10
%\item
%``Efficient Modeling of Individualized COVID-19 Mortality Risk'', UF CTSI Research Day, Gainesville FL, 2023~Apr~14
%\item
