...
\vspace{.75cm}
Laboratory for Systems Medicine, University of Florida \hfill (352) 273-8718 \\
PO Box 100225 \hfill {\tt\small jason.brunson@ufl.edu} \\
Gainesville FL 32610 \hfill {\tt\small\nolinkurl{github.com/corybrunson}}
...
\item
Assistant Professor, Laboratory for Systems Medicine, University of Florida, 2020--
\item
...
\item
S Williams, JJ Zakrzewski, T Hashemian, {\bfseries JC Brunson}, CA Mathews ({\bfseries under review}) Identifying Predictors of Treatment Response in Hoarding Disorder Using Machine Learning.
%\item
%EL Riley, {\bfseries JC Brunson}, JE Lascano, M Campos ({\bfseries under reiew}) Exploratory Analysis to Determine Predictors of Alpha-1 Antitrypsin Deficiency.
\item
...
%\item
%{\bfseries JC Brunson}, CJ Gries, A Emtiazjoo, B Mehrad ({\bfseries under review}) Computational models of chronic lung allograft dysfunction following lung transplantation: A scoping review.
%\item
%X Zhang, T Hashemian, {\bfseries JC Brunson} ({\bfseries under review}) Localized Prediction to Interpolate between Case-Based Reasoning and Machine Learning.
%\item
%{\bfseries JC Brunson}, K Suarez, B Causing, R Elkind, M Terasaki ({\bfseries under review}) Spatial geometry and topology of glomerular capillary networks.
%\item
...
%\item
%{\bfseries JC Brunson}, Y Skaf ({\bfseries under review}) Fixed and adaptive landmark sets for finite pseudometric spaces. {\bfseries Under review.}
\item
...
\item
{\bfseries JC Brunson}, A Patel, S Ali, M Villaneuva, J Justice, B Lobo, Chapurin N, C Atkinson, J Mulligan (2026) Use of machine learning and 71-Plex immune mediator analysis to identify nasal mucus biomarkers associated with olfactory loss in patients with CRSwNP. {\itshape American Journal of Rhinology \& Allergy} Epub ahead of print.
\item
{\bfseries JC Brunson}*, J Jaber*, S Nandavaram, A Emtiazjoo, B Mehrad, DC Patel, D Gomez Manjarres (2025) Understanding Racial Disparities in Lung Transplant Outcomes: A Comparative Study of White and Hispanic Patients. {\itshape Clinical Transplantation} 39(9): e70290.
\item
JGS Souza, M Bertolini, J Liu, BE Nagay, R Martins, RC Costa, {\bfseries JC Brunson}, JA Shibli, LC Figueiredo, A Dongari-Bagtzoglou, M Feres, VAR Bar\~{a}o, B Bor (2025) Exploring the impact of biotic and abiotic surfaces on protein binding modulation and bacteria attachment: integrating biological and mathematical approaches. {\itshape ACS Nano} 19(25): 23393–23413.
\item
...
%\item
%D Nord*, {\bfseries JC Brunson}*, L Langerude, H Moussa, B Gill, T Machuca, M Rackauskas, A Sharma, C Lin, A Emtiazjoo, C Atkinson (2024) Machine Learning with Multi-Site Cytokine Levels is Predictive of Primary Graft Dysfunction following Lung Transplantation. bioRxiv 2024.05.24.595368.
\item
...
\item
A Cohen, P McCall-Junkin, {\bfseries JC Brunson} (2024) Clinical prediction with localized modeling using similarity-based cohorts: A scoping review. medRxiv 2024.06.04.24308433v1.
\item
...
\setcounter{enumi}{\value{paper}}
\item
M Kuhn, {\bfseries JC Brunson} (2026--) {\sffamily ordered}: 'parsnip' Engines and Wrappers for Ordinal Classification Models, version 0.1.0 {\tt\small\nolinkurl{https://cran.r-project.org/package=ordered}}
\item
S Mohanty, S Singh, {\bfseries JC Brunson} (2026--) {\sffamily rgph}: Pair Critical Points and Compute Persistent Homology of Reeb Graphs, version 0.1.0 {\tt\small\nolinkurl{https://cran.r-project.org/package=rgph}}
%\item
%M Kuhn, {\bfseries JC Brunson} (2025--) {\sffamily ordered}: `parsnip' Engines and Wrappers for Ordinal Classification Models, version 0.1.0. {\tt\small\nolinkurl{https://github.com/corybrunson/ordered}}
\item
{\bfseries JC Brunson}, J Gracey (2025--) {\sffamily gggda}: A `ggplot2' Extension for Geometric Data Analysis, version 0.1.1 {\tt\small\nolinkurl{https://cran.r-project.org/package=gggda}}
\item
ST Kelly, MA Black, R Cannoodt, {\bfseries JC Brunson} (2024--) {\sffamily graphsim}: Simulate Expression Data from `igraph' Networks, version 1.0.4 {\tt\small\nolinkurl{https://cran.r-project.org/package=graphsim}}
\item
{\bfseries JC Brunson} (2024--) {\sffamily tdarec}: A `recipes' extension for persistent homology and its vectorizations, version 0.2.0 {\tt\small\nolinkurl{https://cran.r-project.org/package=tdarec}}
\item
A Stamm, {\bfseries JC Brunson} (2024--) {\sffamily phutil}: Persistence Homology Utilities, version 0.0.1 {\tt\small\nolinkurl{https://cran.r-project.org/package=phutil}}
%\item
...
\item
{\bfseries JC Brunson}, E Paul, J Gracey (2020--) {\sffamily ordr}: A `tidyverse' extension for ordinations and biplots, version 0.1.0. {\tt\small\nolinkurl{https://cran.r-project.org/package=ordr}}
\item
RR Wadhwa, M Piekenbrock, {\bfseries JC Brunson}, X Zhang, A Zhang, K Phipps, S Hershkowitz, J Scott (2019--) {\sffamily ripserr}: Calculate Persistent Homology with Ripser-Based Engines, version 1.0.0. {\tt\small\nolinkurl{https://cran.r-project.org/package=ripserr}}
%\item
...
\item
R Wadhwa, A Dhawan, D Williamson, J Scott, {\bfseries JC Brunson}, S Ochi (2018--) {\sffamily TDAstats}: Pipeline for Topological Data Analysis, version 0.4.2. {\tt\small\nolinkurl{https://cran.r-project.org/package=TDAstats}}
%\item
...
\begin{itemize}[label=$\circ$,nolistsep]
\item
{\bfseries Awarded} (impact score 29).
K25 Mentored Quantitative Research Development Award (PA-20-199), Machine Learning as a Tool to Predict Early and Chronic Graft Dysfunction after Lung Transplantation, 2025~Jun~12
\item
{\bfseries Awarded}.
AI2Heal Catalyst Grant,
...
2026~Feb~1--2027~Jan~31
%\item
%{\bfseries Submitted}. AI \& Informatics Research Seed Fund (PI; Co-Is Hochhegger, Wagner), Persistent Homology and Machine Learning of Radiological Images for Characterization and Prediction of Interstitial Lung Disease, 2025~Dec~1
\item
{\bfseries Awarded}.
NIH/NIDCD R01DC022733 (Co-I; PI Mulligan),
Vitamin D as a modulator of inflammation in CRS-related olfactory loss,
2025~May~1--2030~Apr~30
\item
{\bfseries Not funded}.
ISHLT Non-Invasive Biomarker Study Using Artificial Intelligence/Machine Learning Analysis in Lung Transplantation Grant, Machine learning models for biomarkers of primary graft dysfunction following lung transplantation, 2025~Jan~21
\item
{\bfseries Not funded}.
ATS/Foundation for Sarcoidosis Research Grant, Classification and Risk Stratification of Sarcoidosis Patients via Interpretable Machine Learning, 2024~Dec~16
\item
{\bfseries Not funded}.
Foundation for Sarcoidosis Research Pilot Grant, Computational Subtyping of Sarcoidosis Patients, 2024~Aug~6
\item
{\bfseries Not funded}.
K25 Mentored Quantitative Research Development Award (PA-20-199), Machine Learning as a Tool to Predict Acute and Chronic Lung Transplant Graft Dysfunction (resubmission), 2024~Jul~12
\item
{\bfseries Not funded}.
Foundation for Sarcoidosis Research Pilot Grant, Computational Subtyping of Sarcoidosis Patients, 2023~Jul~15
\item
{\bfseries Awarded}.
R Consortium ISC Grant Program, Modular, interoperable, and extensible topological data analysis in R (Co-I; Co-I A Stamm), 2023~Apr~26
\item
{\bfseries Not funded}.
K25 Mentored Quantitative Research Development Award (PA-20-199), Machine Learning as a Tool to Predict Acute and Chronic Lung Transplant Graft Dysfunction, 2023~Oct~12
\item
{\bfseries Not funded}.
Foundation for Sarcoidosis Research Pilot Grant, Computational Subtyping of Sarcoidosis Patients, 2023~Jul~15
\item
{\bfseries Not funded}.
Alpha-1 Foundation In-Cycle Grant, Development and Validation of a Screening Score to Improve the Diagnosis of AATD, 2022~Sep~27
\item
{\bfseries Not funded}.
Foundation for Sarcoidosis Research Pilot Grant, Computational Subtyping of Sarcoidosis Patients, 2022~Jun~20
\item
{\bfseries Awarded}.
CTSI Precision Health Initiative Pilot Grant Program, Efficient Modeling of Individualized COVID-19 Mortality Risk, 2022~Mar~11
\item
{\bfseries Not funded} (impact score 45).
K25 Mentored Quantitative Research Development Award (PA-20-199), Individualized computational modeling to determine outcomes after lung transplantation, 2022~Feb~12
\item
{\bfseries Not funded} (impact score 56).
K25 Mentored Quantitative Research Development Award (PA-20-199), Individualized Modeling of COVID-19 Outcomes using Electronic Health Record Data, 2021~Feb~12
\item
{\bfseries Not funded} (impact score 42).
F32 Postdoctoral Individual National Research Service Award (PA-18-670), Topological data analysis for patient stratification and outcomes
research, 2018~Apr~8
\item
{\bfseries Awarded}.
...
\item
{\bfseries Awarded}.
ACSB 2015: A Conference on Algebraic and Combinatorial Approaches in Systems Biology, NSF DMS \#1503562 (Co-PI; MP Vera--Licona), 2015~May~22--24
\end{itemize}
...
% Emily, Shrihan, Revathi, Hemanth, Sreeya
...
\begin{itemize}[label=$\circ$,nolistsep]
\item
Member, Research Task Force, Faculty Senate, 2023--
\item
...
\item
Host, ``New Books in Mathematics'', New Books Network, 2019-- (25)
\item
...
\begin{itemize}[label=$\circ$,nolistsep]
\item
``Network Data Science as an Opinionated Enabler'', Environmental Data Science Seminar / Department of Mathematics \& Statistics Colloquium, James Madison University, 2025~Nov~18 (invited; oral)
\item
``Modular, interoperable, and extensible topological data analysis in R'' (with A Stamm), R Consortium webinar, online, 2025~Oct~7 (invited)
\item
``Alluvial plots: A paradigm of intermediacy'', Topic-Contributed Paper Session, ``Who are the ggplot2 extenders, and how can you become one?'', Joint Statistical Meetings, Nashville TN, 2025~Aug~2--7 (Aug~5; invited; oral)
\item
``Testing hypotheses of glomerular capillary development with geometric and topological data analysis'', Society for Mathematical Biology Annual Meeting, Edmonton AL, 2025~Jul~13--18 (Jul~15; contributed; oral)
\item
...
%\item
%``Fixed and Adaptive Landmark Sets for Finite Pseudometric Spaces'', SIAM Annual Meeting, Spokane WA, 2024~Jul~8--12 (accepted; oral)
%\item
%``Testing Hypotheses of Glomerular Capillary Development with Geometric and Topological Data Analysis'', SIAM Annual Meeting, Spokane WA, 2024~Jul~8--12 (accepted; poster)
\item
...
%\item
%``Machine learning to identify nasal mucus biomarkers associated with olfactory loss in patients with CRSwNP'', Combined Otolaryngology Spring Meetings, Chicago IL, 2024~May~15--19 (oral)
\item
...
%\item
%``Machine learning and integer programming yield simple risk scores that can increase detection of severe alpha-1 antitrypsin deficiency'', College of Medicine Celebration of Research, Gainesville FL, 2024~Feb~12 (poster)
%\item
%``Computational models of chronic lung allograft dysfunction following lung transplantation: A scoping review'', Department of Medicine Celebration of Research, Gainesville FL, 2023~Oct~26 (poster)
%\item
%``Efficient Modeling of Individualized COVID-19 Mortality Risk'', UF CTSI Learning Health System Research Day, Gainesville FL, 2023~Apr~10 (poster)
%\item
%``Efficient Modeling of Individualized COVID-19 Mortality Risk'', UF CTSI Research Day, Gainesville FL, 2023~Apr~14 (poster)
%\item
%``Adaptive Landmark Selection from Vectorized Patient Data of Varying Density'', AMIA Annual Symposium, Washington DC, 2022~Nov~5--9 (not accepted)
%\item
%``Domain-Informed and -Agnostic Patient Similarity Measures for Individualized Mortality Prediction'', AMIA Annual Symposium, Washington DC, 2022~Nov~5--9 (not accepted)
\item
...
%\item
%``Network analysis to measure disparities in professional healthcare infrastructure'', MiM Journal Club (oral)
\item
...
%\item
%``Conventional versus topological data analysis for disease subtyping: cases of type-2 diabetes mellitus'', MiM Journal Club, 2018 (oral)
%\item
%``Co-occurrence Networks from Correlation Matrices'', CICATS study group, 2018 (oral)
\item
...
\begin{itemize}[label=$\circ$,nolistsep]
\item
Research Conference Preview Journal Club, Pulmonary Division, 2021--2023
\item
