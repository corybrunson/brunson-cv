...
\item
Research Assistant Professor, Laboratory for Systems Medicine, 2020--
\item
...
\item
{\bfseries JC Brunson}, TP Agresta, RC Laubenbacher (2019) Sensitivity of comorbidity network analysis. {\itshape JAMIA Open} 3(1): 94--103.
\item
...
\begin{itemize}[label=$\circ$,nolistsep]
\item
``Toward tidy principles for matrix-decomposed data'', Joint Statistical Meetings, Washington  DC, 2022~Aug~6--11
\item
