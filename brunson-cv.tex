...
%\item
%X Zhang, T Hashemian, {\bfseries JC Brunson} ({\bfseries under review}) Optimization of localized machine learning on clinical classification tasks.
%\item
...
\item
JGS Souza, M Bertolini, J Liu, R Martins, RC Costa, {\bfseries JC Brunson}, JA Shibli, L Figueiredo, A Dongari-Bagtzoglou, VAR Bar\~{a}o, B Bor ({\bfseries under review}) Exploring the impact of biotic and abiotic surfaces on protein binding modulation and initial oral bacteria attachment prediction: integrating biological and mathematical approaches.
\item
...
%\item
%{\bfseries JC Brunson}, J Jaber, S Nandavaram, DC Patel, D Gomez Manjarres ({\bfseries under review}) The Hispanic Paradox in Lung Transplantation: Demography and Outcomes of US Population after Lung Transplantation.
\item
...
\begin{itemize}[label=$\circ$,nolistsep]
%\item
%{\bfseries Submitted}. R Consortium ISC Grant Program, Title, 2023
\item
...
\item
``Machine learning to identify nasal mucus biomarkers associated with olfactory loss in patients with CRSwNP'', Combined Otolaryngology Spring Meetings, Chicago IL, 2024~May~15--19 (accepted; oral)
\item
``Machine Learning with Multi-Site Cytokines Predicts Post--Lung Transplant Primary Graft Dysfunction'', Annual Meeting \& Scientific Sessions of the ISHLT, Prague, Czech Republic, 2024~Apr~10--13 (accepted; oral)
\item
``Machine learning and integer programming yield simple risk scores that can increase detection of severe alpha-1 antitrypsin deficiency'', UF+FSU Translational Research Symposium, Gainesville FL, 2024~Mar~7 (accepted; poster)
%\item
