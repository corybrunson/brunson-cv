...
%\item
%{\bfseries JC Brunson}, CJ Gries, A Emtiazjoo, B Mehrad (2023) Computational models of chronic lung allograft dysfunction following lung transplantation: A scoping review. {\bfseries Under review.}
%\item
%S Williams, JJ Zakrzewski, T Hashemian, {\bfseries JC Brunson}, CA Mathews (2023) Identifying Predictors of Treatment Response in Hoarding Disorder Using Machine Learning. {\bfseries Under review.}
%\item
%X Zhang, T Hashemian, {\bfseries JC Brunson} (2023) Optimization of localized machine learning on clinical classification tasks. {\bfseries Under review.}
%\item
%{\bfseries JC Brunson}, M Terasaki (2023) Spatial geometry and topology of glomerular capillary networks. {\bfseries Under review.}
%\item
%M Bertolini, {\bfseries JC Brunson}, J Gabriel (2023) Title. {\bfseries Under review.}
\item
...
%\item
%{\bfseries JC Brunson}, J Jaber, S Nandavaram, DC Patel, D Gomez Manjarres (2023) Racial-ethnic disparities in post-transplant outcomes of lung recipients. {\bfseries Under review.}
\item
...
%\item
%{\bfseries JC Brunson}, Y Skaf (2023) Fixed and adaptive landmark sets for finite pseudometric spaces. {\bfseries Under review.}
\item
