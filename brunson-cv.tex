...
%\item
%{\bfseries JC Brunson} ({\bfseries under review}) ordr: Ordination and Biplots in Tidyverse Workflows
%\item
...
\item
{\bfseries JC Brunson}*, J Jaber*, S Nandavaram, A Emtiazjoo, B Mehrad, DC Patel, D Gomez Manjarres ({\bfseries in press}) Understanding Racial Disparities in Lung Transplant Outcomes: A Comparative Study of White and Hispanic Patients. {\itshape Clinical Transplantation}.
\item
JGS Souza, M Bertolini, J Liu, BE Nagay, R Martins, RC Costa, {\bfseries JC Brunson}, JA Shibli, LC Figueiredo, A Dongari-Bagtzoglou, M Feres, VAR Bar\~{a}o, B Bor ({\bfseries in press}) Exploring the impact of biotic and abiotic surfaces on protein binding modulation and bacteria attachment: integrating biological and mathematical approaches. {\itshape ACS Nano} 2025 Jun 15. Epub ahead of print.
\item
