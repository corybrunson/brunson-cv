...
%\item
%{\bfseries JC Brunson}, CJ Gries, A Emtiazjoo, B Mehrad (2022) Computational models of chronic lung allograft dysfunction following lung transplantation: A scoping review. {\bfseries Under review.}
%\item
%X Zhang, T Hashemian, {\bfseries JC Brunson} (2022) Optimization of localized machine learning on clinical classification tasks. {\bfseries Under review.}
%\item
%{\bfseries JC Brunson}, M Terasaki (2022) Spatial geometry and topology of glomerular capillary networks. {\bfseries Under review.}
%\item
%M Bertolini, {\bfseries JC Brunson}, J Gabriel (2022) Title. {\bfseries Under review.}
%\item
%E Nitch-Griffin, A Peterson, Y Skaf, {\bfseries JC Brunson} (2022) External validity of personalized mortality Prediction. {\bfseries Under review.}
%\item
%{\bfseries JC Brunson}, J Jaber, S Nandavaram, DC Patel, D Gomez Manjarres (2022) Racial-ethnic disparities in post-transplant outcomes of lung recipients. {\bfseries Under review.}
\item
...
\item
L Riley, {\bfseries JC Brunson}, S Eydgahi, M Brantly, J Lascano (2023) Development of a Risk Score to Increase Detection of Severe Alpha-1 Antitrypsin Deficiency. {\itshape ERJ Open Research}: Epub ahead of print.
\item
...
%\item
%{\bfseries Submitted}. K25 Mentored Quantitative Research Development Award (PA-20-199), Title, 2023~Oct~12
%\item
...
\item
{\bfseries Awarded}. CTSI Precision Health Initiative Pilot Grant Program, Efficient Modeling of Individualized COVID-19 Mortality Risk, 2022~Mar~11% (pending IRB and NIH approval)
\item
